...
export function Footer() {
  return (
    <footer className="mt-10 border-t border-line bg-cream pb-28 pt-10 md:mt-14 md:pb-10">
      <div className="shell">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <nav aria-labelledby="f-tienda">
            <h2 id="f-tienda" className="mb-2.5 text-micro font-extrabold uppercase tracking-wide text-ink">Tienda</h2>
          ...
          <nav aria-labelledby="f-clinica">
            <h2 id="f-clinica" className="mb-2.5 text-micro font-extrabold uppercase tracking-wide text-ink">Clínica</h2>
            <ul className="text-body text-muted">
          ...
          <div>
            <h2 className="mb-2.5 text-micro font-extrabold uppercase tracking-wide text-ink">Sedes</h2>
        ...
        <div className="mt-8 border-t border-line pt-5">
          ...
          <ul className="flex flex-wrap gap-1.5">
            {PAGOS.map((p) => (
              <li key={p}>
                <span className="inline-flex h-8 items-center rounded-sm bg-white px-2.5 text-micro font-bold text-ink shadow-inset1">{p}</span>
              </li>
            ))}
          </ul>
