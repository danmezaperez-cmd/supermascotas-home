...
export const banners: Banner[] = [
  {
    ...
    titulo: 'Hasta 25% menos en alimento para perro',
    bajada: 'Con precio por kilo a la vista, para que compares de verdad.',
  ...
  },
  {
    ...
    bajada: 'Laboratorio e imágenes diagnósticas en la misma sede. Ninguna otra tienda de Cali lo tiene.',
  ...
  },
  {
    ...
    bajada: 'Llega solo cada 30 o 45 días. Cambias o cancelas cuando quieras.',
